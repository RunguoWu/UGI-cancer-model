...
# all stage 4 dwelling use 0.25-1
# Stage 4 dwelling in effect will not impact simulation result
...
# args <- c("1", "/data/WIPH-CanDetect/HealthEco/output/optim", "age70plus", "female", "RS", "500000", "opt_upd2026")
###### input parameters
